  ...
  const Inner = (
    <>
      ...
      <form className="mt-6 space-y-6" onSubmit={(e) => e.preventDefault()}>
        <label className="block text-sm font-medium text-white/90">E-mail</label>
        <div className="relative">
          ...
          <span className="pointer-events-none absolute inset-y-0 left-3 flex items-center text-slate-700">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16v16H4z"/><path d="m22 6-10 7L2 6"/></svg>
          </span>
        </div>
      ...
      <p className="mt-6 text-center text-sm text-white/80">
        Don&apos;t have an account? <button type="button" className="underline hover:text-white">Register</button>
      </p>
